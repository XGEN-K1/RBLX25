...
local whitelistConfigs = {
	...
	},
	{
		...
		names = { "Silver", "Gold", "Ancient Rune", "Flower Grass", "Pink Diamond"},
		color = Color3.new(0, 0, 1)
	}
}

local blacklistTrees = { "Oak", "Fir", "Birch", "Acacia", "Cherry", "Lush Oak", "Palm", "Pine", "Redwood", "Willow", "Maple", "Kelp", "Silverwood Tree"}
local blacklistOres = { "Iron","Copper", "Stone", "Aluminium", "Amber", "Bush", "Clay", "Cloudnite", "Deepslate", "Diamond", "Emerald", "Marble", "Null", "Quartz", "Tin", "Tall Grass", "Ice", "Coal", "Blastshard", "Voltshard", "Salt", "Jade", "Sand", "Scarlet", "Sapphire" }
