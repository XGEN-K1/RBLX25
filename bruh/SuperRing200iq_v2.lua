...
RunService.Heartbeat:Connect(function()
    if not ringPartsEnabled then return end -- Перевіряємо, чи увімкнено функціонал

    -- Отримання вибраного гравця
    local targetPlayer = getgenv().SelectedPlayer or LocalPlayer -- Використовуємо глобальну змінну
    ...
    if character then
        ...
        if humanoidRootPart then
            ...
            -- Логіка обертання частин навколо центру (торнадо)
