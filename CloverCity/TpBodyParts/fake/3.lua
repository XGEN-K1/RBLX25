...
local TELEPORT_OFFSET_Y = -7

-- Налаштування для підйому та спуску
local RAISE_KEY = Enum.KeyCode.X
local LOWER_KEY = Enum.KeyCode.C
local MOVE_SPEED = 0.2  -- Швидкість руху
local RAISE_SPEED = 0.1  -- Швидкість підйому
local LOWER_SPEED = 0.1  -- Швидкість спуску
local MOVE_INTERVAL = 0.1  -- Інтервал для руху
